...
import { BankPaymentRepository } from 'src/payment/models/bankPayment/bankPayment.repository';
...
export class AllDataService {
  constructor(
    ...
    private readonly bankAccountRepo: BankPaymentRepository, // private readonly paymentService: PaymentService,
  ) {}
  ...
  async getAllBankAccounts(): Promise<any> {
    return this.bankAccountRepo.getAllBankPayment();
  }
